(function() {
  var RouteResolver, View, ViewServer, ViewServerManager, array_flatten, array_from, bind_extend_handler, create_server, deffered, eco, environments, express, extend, file_exists, files_with_extension, fs, history_available, http, is_array, is_directory, jade, process_asset_arguments, proxy, setup_static_provider_and_routes, url, _, _ref;
  ...
  ViewServer.extend({
    respond: function(request, response) {
      ...
      return require('child_process').exec(command, __bind(function(error, stdout, stderr) {
        var key, params, send_response, view_name;
