(function() {
  var ViewServer, ViewServerManager, array_flatten, array_from, bind_extend_handler, create_server, deffered, eco, environments, express, extend, files_with_extension, fs, http, is_array, is_directory, jade, process_script_arguments, proxy, setup_static_provider_and_routes, url, _;
