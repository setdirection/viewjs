(function() {
  var ViewServer, ViewServerManager, XMLHttpRequest, array_flatten, array_from, bind_extend_handler, create_empty_document, create_server, deffered, eco, environments, express, extend, files_with_extension, fs, http, is_array, is_directory, jade, jsdom, proxy, setup_static_provider_and_routes, url, _;
