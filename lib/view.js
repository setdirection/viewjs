(function() {
    ...
    stack: {
      initialize: {
        add: function() {
          ...
          if (args[0]) {
            this._initialize_callback = args[0];
          }
          return next();
        }
      }
    ...
    env: function(envs) {
      ...
      if (arguments.length === 2) {
        ...
        if (!(environments[env_name] != null)) {
          return environments[env_name] = callback;
  ...
  View.extend({
    extend: {
      env: function(envs) {
        ...
        for (env_name in envs) {
          args = envs[env_name];
          _results.push(environments[env_name]() ? typeof args === 'function' ? (response = args(), response ? this.extend(response) : void 0) : this.extend(args) : void 0);
        }
        return _results;
      }
    }
  ...
  View.extend({
    ...
    $: function(dom_library) {
      var selector;
      if (arguments.length === 1 && (((typeof jQuery != "undefined" && jQuery !== null) && dom_library === jQuery) || ((typeof Zepto != "undefined" && Zepto !== null) && dom_library === Zepto))) {
        return this._$ = dom_library;
      } else if (arguments.length === 1 && typeof dom_library === 'string') {
  ...
  delegate_events = function(events, element) {
    var event_name, key, method, method_name, selector, _ref, _ref2, _ref3, _ref4, _results;
    ...
    _results = [];
    for (key in _ref3) {
      method_name = _ref3[key];
      _ref4 = key.match(/^(\w+)\s*(.*)$/), event_name = _ref4[0], selector = _ref4[1];
      method = proxy(this[method_name], this);
      _results.push(selector === '' ? this._$(element).bind(event_name, method) : this._$(element).delegate(selector, event_name, method));
    }
    return _results;
  };
  View.extend({
