(function() {
  ...
  ViewSerializer = {
    setup: function(options) {
      return this.stylesheets = options.stylesheets, this.javascripts = options.javascripts, this.execute = options.execute, this.public = options.public, this.domain = options.domain, this.routes = options.routes, this.url = options.url, options;
    },
    ...
    serialize: function(callback) {
      return this.createWindow(__bind(function(window) {
        if (window.View != null) {
          ...
          return callback(this.renderWindow(window, request));
        }
      }, this));
    }
  };
