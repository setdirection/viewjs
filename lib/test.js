(function() {
  var Backbone, Builder, Logger, RouteResolver, Router, View, array_from, assert, jsdom, _ref;
  var __bind = function(fn, me){ return function(){ return fn.apply(me, arguments); }; };
  assert = require('assert');
  _ref = require('../lib/view.js'), View = _ref.View, Builder = _ref.Builder, Router = _ref.Router, RouteResolver = _ref.RouteResolver, Logger = _ref.Logger;
    ...
    _ref = View.create({
      ...
      ContainerView: [
        Router, {
          views: ['SidebarView'],
          render: function() {
            return this.tag('div', this.SidebarView, this.tag('div', this.router));
          }
        }
      ],
      AlphabetView: {}
  ...
  module.exports.canUse$InBuilder = function() {
    ...
    $BuilderView = View.create({
      $BuilderView: {
        ...
        render: function() {
          this.key = 'test';
          this.table(this.tr(this.td(), this.td()));
          return this.div().click(function() {
            ++click_count;
