(function() {
  var Backbone, Builder, Logger, RouteResolver, Router, TestServer, View, ViewServer, array_from, assert, http, jQuery, jsdom, _ref;
  ...
  module.exports.canServeBasicApp = function(before_exit) {
    var BasicAppServer, public, request_count;
    request_count = 0;
    ...
    BasicAppServer = TestServer.create({
      BasicAppServer: {
        ...
        execute: ["" + public + "/javascripts/lib/jquery.js", "" + public + "/javascripts/lib/underscore.js", "" + public + "/javascripts/lib/backbone.js", "" + public + "/javascripts/lib/view.js", "" + public + "/javascripts/views/basic.js"]
      }
    }).BasicAppServer;
    return http.get({
      host: 'localhost',
