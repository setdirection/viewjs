(function() {
  var Backbone, Builder, Logger, RouteResolver, Router, View, ViewServer, array_from, assert, jQuery, jsdom, _ref;
  ...
  module.exports.canCreateBasicServer = function() {
    var TestServer;
    ...
    return TestServer.server.close();
  };
  module.exports.serverCanRenderTemplate = function() {
    var TemplateServer;
    View.create({
    ...
    TemplateServer = ViewServer.create({
      TemplateServer: {
        port: 99998,
    ...
    return http.get({
      ...
      return TemplateServer.server.close();
    });
  };
}).call(this);
