(function() {
  var Backbone, Builder, Logger, RouteResolver, Router, TestServer, View, ViewServer, array_from, assert, file_exists, fs, http, jQuery, jsdom, public, _ref;
  var __bind = function(fn, me){ return function(){ return fn.apply(me, arguments); }; };
  assert = require('assert');
  _ref = require('./view.client.js'), View = _ref.View, Builder = _ref.Builder, Router = _ref.Router, RouteResolver = _ref.RouteResolver, Logger = _ref.Logger;
  ...
  module.exports.canServeBasicApp = function(before_exit) {
  ...
  module.exports.canServeProxies = function(before_exit) {
      ...
      return response.on('data', function(data) {
        ...
        return http.get({
          ...
          return response.on('data', function(data) {
            ...
            return before_exit(function() {
              return assert.equal(data.toString(), 'b');
            });
          });
        });
      });
  ...
  module.exports.envsExecuteCorrectly = function(before_exit) {
    var ConditionalViewServer;
    ViewServer.env({
      set: {
        a: function() {
          return false;
    ...
    return http.get({
      ...
      return response.on('data', function(data) {
        return before_exit(function() {
          ...
          return ConditionalViewServer.server.close();
        });
      });
    });
  };
  module.exports.canCache = function(before_exit) {
    var CachingViewServer;
    CachingViewServer = ViewServer.create({
      CachingViewServer: {
        port: 4008,
        routes: {
          '/': 'BasicView',
