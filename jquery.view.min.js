...
return b}else if(typeof a==="string"||typeof a=="number")return this._attributes[a]},set:function(a,b,d){if(typeof a==="object"){d={};for(var c in a)d[c]=this.set(c,a[c],b);return d}else{this._attributes[a]=b;this._changes[a]=b;if(d===q){this.trigger("change:"+a,b);this.trigger("change",this._changes);this._changes={}}return b}},bind:e.view.classMethods.bind,unbind:e.view.classMethods.unbind,one:e.view.classMethods.one,trigger:function(a){if((!this.constructor._observers||!this.constructor._observers[a]||
this.constructor._observers[a]&&this.constructor._observers[a].length==0)&&(!this._observers||!this._observers[a]||this._observers[a]&&this._observers[a].length==0))return[];var b=o(arguments).slice(1),d=[];constructor_args=o(arguments).slice(1);constructor_args.unshift(this);constructor_args.unshift(a);var c=this.constructor.trigger.apply(this.constructor,constructor_args);if(c===false)return false;d=d.concat(c);a in this._observers||(this._observers[a]=[]);for(var i=0;i<this._observers[a].length;++i){c=
this._observers[a][i].apply(this._observers[a][i],b);if(c===false)return false;else d.push(c)}return d},ready:e.view.classMethods.ready,emit:function(){var a=o(arguments),b=this;return function(){return b.trigger.apply(b,a)}},map:function(a,b,d){d=d||[];if(typeof a==="string")a=this.get(a);if(u(a))for(var c=0;c<a.length;++c)d.push(b.apply(this,[a[c],c]));else{c=0;for(var i in a){typeof a[i]==="function"?this.map(this.get(i),a[i],d):d.push(b.apply(this,[i,a[i],c]));++c}}return d},callback:function(a){var b=
o(arguments).slice(1),d=this;return function(){typeof a==="string"?d[a].apply(d,b):a.apply(d,b);return false}},delegate:function(a,b,d,c){if(c)d=t(d,c);this._element?e(this._element).delegate(a,b,d):this._delegates.push([a,b,d])},escape:function(a){return document.createTextNode(a)},render:function(a,b){var d={},c;for(c in this)if(I(c,["_delegates","_observers","_attributes","_changes"])==-1)d[c]=this[c];w(d,this.attributes());w(d,b);return this.constructor.engine().render(a,d)}};e.view.logging=false;
